-- ============================================================================
-- Lualine Style J: "Heavy" █
-- Chunky industrial strength — full blocks, bold mode names, thick dividers
-- Section seps: ▐█/█▌ (double-block combo — maximum visual weight)
-- Component seps: ┃ (thick vertical bar)
-- Feel: Bold, weighty, industrial, commanding
-- ============================================================================
...
-- Mode icons — full blocks for active modes
local mode_icons = {
...
lualine.setup({
  options = {
    theme = 'auto',
    -- Double-block separators: ▐█ creates a thick wall between left sections,
    -- █▌ on the right side. Heavy visual anchor points.
    section_separators = { left = '▐█', right = '█▌' },
    -- Thick vertical bar — bold but not overwhelming
  ...
  -- ═══════════════════════════════════════════════════════════════
  -- BOTTOM BAR: Heavy industrial
  --   a: mode    b: git    c: file+status    x: diag    y: aerial    z: lines+pos+progress
  -- ═══════════════════════════════════════════════════════════════
  sections = {
    lualine_a = {
    ...
    lualine_b = {
      { git_info, padding = { left = 2, right = 2 } },
    },
    lualine_c = {
    ...
    lualine_z = {
      { line_count, padding = { left = 2, right = 2 } },
      { position, padding = { left = 2, right = 2 } },
  ...
  -- ═══════════════════════════════════════════════════════════════
  -- TABLINE: Heavy tab bar for when multiple tabs are open
  -- ═══════════════════════════════════════════════════════════════
  tabline = {
    lualine_a = {
      {
        ...
        mode = 1,
        tabs_color = {
          active = 'LualineVisual', -- Use visual mode highlight for active tab
          inactive = 'LualineInactive',
        },
