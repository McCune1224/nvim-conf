...
-- Git signs, blame, and hunk navigation
-- ============================================================================
...
gitsigns.setup({
  ...
  on_attach = function(bufnr)
    ...
    end, { buffer = bufnr, desc = '[G]it [H]unk [S]tage' })
