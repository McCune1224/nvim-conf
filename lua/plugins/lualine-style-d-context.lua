-- ============================================================================
-- Lualine Style D: "Context" ⊞
-- Navigation-focused: shows current function/symbol, encoding per-buffer
-- Uses tabline for aerial, winbar for git context, statusline for code info
-- ============================================================================
...
lualine.setup({
  options = {
    theme = 'auto',
    -- Rounded pill-style separators — subtle transitions
  ...
  -- ═══════════════════════════════════════════════════════════════
  -- WINBAR: Git context + per-buffer encoding
  -- ═══════════════════════════════════════════════════════════════
  winbar = {
    lualine_a = {
  ...
  -- ═══════════════════════════════════════════════════════════════
  -- BOTTOM BAR: Navigation focus
  --   a: mode    b: aerial    c: file+encoding    y: diag    z: pos
  -- ═══════════════════════════════════════════════════════════════
  sections = {
    lualine_a = {
