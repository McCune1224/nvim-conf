-- ============================================================================
-- Lualine Style F: "Arrow" 
-- Sharp slanted angles create forward-flowing directional momentum
-- Section seps: / (angled powerline extended - solid fill arrows)
-- Component seps: ▎ (thin vertical bar)
-- Feel: Dynamic, sharp, modern, fast
-- ============================================================================
...
lualine.setup({
  options = {
    theme = 'auto',
    -- Sharp angles:  points right like an arrow,  points left
    -- Creates forward momentum from left to right
    section_separators = { left = '', right = '' },
    -- Thin vertical bars as component dividers — clean but defined
  ...
  -- ═══════════════════════════════════════════════════════════════
  -- BOTTOM BAR: Arrow flow
  --   a: mode    b: git    c: file+status    x: diagnostics    y: aerial    z: position+progress
  -- ═══════════════════════════════════════════════════════════════
  sections = {
    lualine_a = {
      { get_mode_display, padding = { left = 2, right = 1 } },
    },
    lualine_b = {
