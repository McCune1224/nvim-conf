-- ============================================================================
-- LSP Configuration
-- Native Neovim 0.12 LSP with custom hover and border styling
-- ============================================================================
...
-- Use single border for consistency with diagnostics
M.border_style = M.border.single
...
-- Open URL in browser (for hover window)
M.open_url = function()
...
-- On attach callback for buffer-local features
M.on_attach = function(client, bufnr)
  ...
  -- Document color (CSS, etc.)
  if client:supports_method('textDocument/documentColor') then
    vim.lsp.document_color.enable(true, { bufnr = bufnr })
  end

  -- Enable native completion if blink is not available
